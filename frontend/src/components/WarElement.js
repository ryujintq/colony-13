const War = ({ war, onClick }) => {
    ...
    return (
        <div className={`grid border-b grid-cols-3 ${isPast === true ? 'sm:grid-cols-4' : ''} py-3 cursor-pointer bg-black bg-opacity-50 hover:bg-white hover:bg-opacity-20`} onClick={onClick}>
